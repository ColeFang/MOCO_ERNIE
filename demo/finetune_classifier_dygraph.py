...
if __name__ == '__main__':
    ...
    parser.add_argument('--from_pretrained', default='ernie-2.0-large-en', type=str, help='pretrained model directory or tag')
    ...
    parser.add_argument('--data_dir', default='E:/ERNIE/data',type=str,  help='data directory includes train / develop data')
    ...
    with FD.guard(place):
        ...
        if args.use_lr_decay:
            opt = AdamW(learning_rate=LinearDecay(args.lr, int(args.warmup_proportion * args.max_steps), args.max_steps),
                        parameter_list=model.parameters(), weight_decay=args.wd, grad_clip=g_clip)
        else:
